...
def parse_args():
    ...
    parser.add_argument("--load_dir", help="load_dir", default='/media/hdd/xucao/dataset/waymo_open_dataset')
    parser.add_argument("--save_dir", help="save_dir", default='/media/hdd/xucao/dataset/semantickitti_format/dataset/sequences')
